...
read.data <- function() {
        ...
        products <- read.xlsx2("./visualizer/data/bikes.xlsx", sheetIndex = 1,
                               colClasses = c("numeric", "character", "character", 
                                              "character", "character", "numeric")
        )
        customers <- read.xlsx2("./visualizer/data/bikeshops.xlsx", sheetIndex = 1,
                                colClasses = c("numeric", "character", "character", 
                                               "character", "numeric", "numeric")
        )
        orders <- read.xlsx2("./visualizer/data/orders.xlsx", sheetIndex = 1, colIndex = 2:7,
